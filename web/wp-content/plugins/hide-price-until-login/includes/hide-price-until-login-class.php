				...
				<div class="ced_hpul_email_image">
					<div class="ced_hpul_email_main_content">
						...
						<div class="hide"  id="ced_hpul_loader">	
							<img id="ced-hpul-loading-image" src="<?php echo plugins_url().'/hide-price-until-login/assets/images/market-place.jpg'?>" >
						</div>
						<div class="ced_hpul_banner">
							<a target="_blank" href="https://cedcommerce.com/offers#woocommerce-offers"><img src="<?php echo plugins_url().'/hide-price-until-login/assets/images/market-place-2.jpg'?>"></a>
						</div>
					</div>
				</div>
			<?php endif;?>
...
add_filter( 'woocommerce_get_settings_pages', 'hide_price_until_login_plugin_setting_class_initiate',999 );
?>